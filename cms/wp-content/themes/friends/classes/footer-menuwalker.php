 ...
 ************/
  ...
  class FooterMenuNavwalker extends Walker_Nav_Menu {
    /**
      ...
      if ( ! $args['has_children'] ) {//if doesn't have children
            if ( ! in_array( 'navbar-divider', $classes ) ) {//if doesnt contains a navbar divider
              ...
              if ( ! empty( $fa ) ) {//if item title is not empty
                ...
                $item_output .= '<li class="site-footer__navigation-list-item"><a' . $class_names . $attributes . '>';//item empty use defaults
              }
        ...
        $item_output .= $indent . '<li class="site-footer__navigation-list-item navbar-item--submenu-button has-dropdown is-hoverable" data-target="dropdown"><!-- START DROPDOWN-->' . "\n";
    ...
    private function get_item_classes( $item, $args ) {
      ...
      $classes[]   = 'site-footer__navigation-list-item';
    ...
    public static function fallback( $args ) {
      if ( current_user_can( 'edit_theme_options' ) ) {
        ...
        echo '>';
        echo '<a class="site-footer__navigation-list-item" href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" title="">' . esc_attr( 'Add a menu', 'worldoweb' ) . '</a>';
        echo '</div>';
        if ( $container ) {
          echo '</' . esc_attr( $container ) . '>';
        }
