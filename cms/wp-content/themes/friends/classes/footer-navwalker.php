      ...
      if ( ! $args['has_children'] ) {//if doesn't have children
            if ( ! in_array( 'navbar-divider', $classes ) ) {//if doesnt contains a navbar divider
              ...
              if ( ! empty( $fa ) ) {//if item title is not empty
                ...
                $item_output .= '<li class="site-footer-navbar__navigation-list-item"><a' . $class_names . $attributes . '>';//item empty use defaults
              }
        ...
        $item_output .= $indent . '<li class="site-footer-navbar__navigation-list-item site-footer__main-navigation-list-item--submenu-item has-dropdown is-hoverable" data-target="dropdown"><!-- START DROPDOWN-->' . "\n";
